...
namespace Bot_Application1 {
    ...
    public partial class molgovtw {
        ...
        private static XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new XmlSerializerFactory().CreateSerializer(typeof(molgovtw));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string input, out molgovtw obj, out System.Exception exception) {
            exception = null;
            obj = default(molgovtw);
            try {
        ...
        public static bool Deserialize(string input, out molgovtw obj) {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public static molgovtw Deserialize(string input) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(input);
                return ((molgovtw)(Serializer.Deserialize(XmlReader.Create(stringReader))));
            } finally {
        ...
        public static molgovtw Deserialize(System.IO.Stream s) {
            return ((molgovtw)(Serializer.Deserialize(s)));
        }
        #endregion
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out molgovtw obj, out System.Exception exception) {
            exception = null;
            obj = default(molgovtw);
            try {
        ...
        public static bool LoadFromFile(string fileName, out molgovtw obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static molgovtw LoadFromFile(string fileName) {
